package com.fjsh.multi.source.calcite.learn;
...
public class JavaHrSchema {
   ...
   /* public final List<Employee> emps = ImmutableList.of(new Employee(100, "bluejoe", 1),
            new Employee(200, "wzs", 2), new Employee(150, "wxz", 1));

    public final List<Department> depts = ImmutableList.of(new Department(1, "dev"),
            new Department(2, "market"));*/
}
